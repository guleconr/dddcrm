...
defaultMenuCollapse(),
  ...
  $(function () {
    ...
    null !== e && (e.indeterminate = !0),
      ...
      $(".notification-button, .profile-button, .translation-button, .dropdown-settings,.dropdown-menu").dropdown({ inDuration: 300, outDuration: 225, constrainWidth: !1, hover: !1, gutter: 0, coverTrigger: !1, alignment: "right" }),
    ...
    M.Collapsible.init(a, { accordion: !1 });
    ...
    var t,
      o = $("li.active .collapsible-sub .collapsible"),
    ...
    if (
      (0 < o.find("a.active").length && (o.find("a.active").closest("div.collapsible-body").show(), o.find("a.active").closest("div.collapsible-body").closest("li").addClass("active")),
        (t =
        ...
        0 < $("#slide-out.leftside-navigation").length && !$("#slide-out.leftside-navigation").hasClass("native-scroll"))
    )
    ...
    if (0 < $("#ul-horizontal-nav").length) var d = new PerfectScrollbar("#ul-horizontal-nav", { wheelPropagation: !1 });
    ...
    var c = $("#right-sidebar-nav #slide-out-chat .chat-body .collection");
