...
namespace TBBProject.Core.Data.Migrations
{
    ...
    [Migration("20210422065506_DynamicMenu Creator Migration V2")]
    partial class DynamicMenuCreatorMigrationV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TBBProject.Core.Data.Domain.DynamicMenu", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TBBProject.Core.Data.Domain.DynamicMenuItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("DynamicMenuId");

                    b.ToTable("DynamicMenuItem");
                });

            modelBuilder.Entity("TBBProject.Core.Data.Domain.DynamicMenuResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TBBProject.Core.Data.Domain.DynamicMenuItem", b =>
                {
                    b.HasOne("TBBProject.Core.Data.Domain.DynamicMenu", "DynamicMenu")
                        .WithMany("DynamicMenuItems")
                        .HasForeignKey("DynamicMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
